"""
The script reprojects 2.5" resolution of Spitzer map (from Spitzer archive) 
...
Spitzer_infile = 'SPITZER_I1_34836224_0000_1_E6097259_maic.fits' # level 2 product of spitzer archive
...
hdu2_ch1[0].data = hdu2_ch1[0].data / (42545 * 1 / (hdu2_ch1[0].header['PXSCAL2'])**2)
print(hdu2_ch1[0].header['PXSCAL2'])
print((42545 * 1 / (hdu2_ch1[0].header['PXSCAL2'])**2))  # this part is conversion from MJy/sr to Jy/px
...
header['history'] = '--------------------------------------------------'
header['history'] = 'Used script:    3_reproject_spitzer.py'
...
new_hdul.writeto(outpath + '3_Spitzer_bin3_ch1_xheader_jy.fits', overwrite=True)
